...
// End Cross Module References
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UGameTaskGraphNode_Statics::NewProp_Events_Inner = { "Events", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UGameTaskGraphNode_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UGameTaskGraphNode_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UGameTaskGraphNode_Statics::NewProp_Events,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UGameTaskGraphNode_Statics::NewProp_Events_Inner,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGameTaskGraphNode_Statics::ClassParams = {
		...
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_UGameTaskGraphNode_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UGameTaskGraphNode_Statics::PropPointers),
		0,
		0x000000A0u,
